...
if ($result2->num_rows > 0) {
    while ($con = $result2->fetch_assoc()) {
        ...
        ?>
                            <li class="clearfix"
                                onclick="window.location.href='chat.php?id=<?php echo $idP ?>&vend=<?php echo $idVen ?>';">
...
?>
                            ...
                            if (isset($_GET['id']) && isset($_GET['vend'])) {
                                ...
                                $sql = "SELECT * FROM utilizador WHERE id = '$vend'";
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="chat-about">
                                        ...
                                        <small onclick="window.location.href='sproduct.php?id= <?php echo $id ?>';"
                                            style="cursor: pointer; color: black; font-size: 14px;">
                                            <?php
                                            if (isset($_GET['id']) && isset($_GET['vend'])) {
                                                echo $tit;
                                            } else {
                        ...
                        <div class="chat-history" id="chat-history">
                            <ul class="m-b-0">
                                ...
                                if (isset($_GET['id']) && isset($_GET['vend'])) {
                                    ...
                                    $sql = "SELECT * FROM chat WHERE utilizador1 = '$idCom' AND utilizador2 = '$vend' AND produto = '$id'
                UNION
                SELECT * FROM chat WHERE utilizador1 = '$vend' AND utilizador2 = '$idCom' AND produto = '$id'
                ORDER BY dataHora ASC";

                                    $sql_query = mysqli_query($conn, $sql);
                                    if ($sql_query->num_rows > 0) {
                                        while ($msg = $sql_query->fetch_assoc()) {
                                            ?>
                                <li class="clearfix">
                                    <div
                                        class="message-data <?php echo ($msg['utilizador1'] == $idCom) ? 'text-right' : ''; ?>">
                                        <span class="message-data-time"><?php echo $msg['dataHora']; ?></span>

                                    </div>
                                    <div
                                        class="message <?php echo ($msg['utilizador1'] == $idCom) ? 'other-message float-right' : 'my-message'; ?>">
        ...
        ?>
                        ...
                        <div class="chat-message clearfix">
                            <form method="POST" action="processaChat1.php" enctype="multipart/form-data">
                                ...
                                <div class="input-group mb-0">
                                    ...
                                    <input type="hidden" name="vend" value="<?php echo $vend; ?>">
    ...
    function addFav(str) {
        ...
        xhttp.open("GET", "addFav.php?fav=" + str.value, true);
        xhttp.send();
        //window.location = "addFav.php";
    }
    </script>
</body>
