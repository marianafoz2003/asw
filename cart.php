...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    echo $userAuth
                    ?>
                    <li><i onclick=window.location.href="fav.php" ; class="fal fa-heart"></i> </li>
                    <!-- <li class="nav-item">
    ...
    <section id="cart" class="container pt-5">
        <h2 class="font-weight-bold pt-5 mt-5">Carrinho</h2>
        <hr>
    </section>
    ...
    <section id="cart-bottom" class="container">
        <div class="row">
            <div class="coupon col-lg-6 col-md-6 col-12 mb-4">
                <div>
                    <h5>DADOS</h5>
                    <p>Número do Cartão Débito/Crédito</p>
            ...
            <div class="total col-lg-6 col-md-6 col-12">
                <div>
                    ...
                    <button class="ml-auto"
                        onclick="window.location.href='processaCompra.php?id=<?php echo urlencode($id); ?>';">PAGAR</button>
                </div>
