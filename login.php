            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card p-4">
                        ...
                        <form action="procLogin.php" method="post" name="login">
                            <div class="form-group">
                                <label for="email" class="form-label">Email:</label>
                                <input type="text" class="form-control" id="email" aria-describedby="emailHelp"
                                    name="email" required>
                                <!-- <div id="emailHelp" class="form-text">Os seus dados serão sempre protegidos.</div> -->
                            </div>
                            <div class="form-group">
                            ...
                            <!-- <div class="mb-3 form-check">
                                ...
                                <label class="form-check-label" for="remember">Memorizar</label>
                            </div> -->
                            <button type="submit" class="btn-block buy-btn">Iniciar Sessão</button>


                            <div class="mt-3">
                                <p class="text-center">Não tem conta? <a href="register.php">Registe-se</a></p>
                        </form>
                    </div>
                </div>
            </div>
